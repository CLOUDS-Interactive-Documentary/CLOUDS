...
- (void)setup
{
    ...
    for (NSTableColumn *tableColumn in keywordTableSource.tableColumns ) {
...
{
    CloudsClip& c = (selectedClipsSource.size() == 0) ? parser.getAllClips()[clipTableSource.selectedRow] : selectedClipsSource[clipTableSource.selectedRow];
