...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 73.0, 566.894226, 77.0, 23.0 ],
					"text" : "used slots"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : [ "fuller", "waves", "and", "beats" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 14.0,
					"id" : "obj-65",
					"items" : [ "none", ",", "straight", ",", "pattern", ",", "lsys" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
