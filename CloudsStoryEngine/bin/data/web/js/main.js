	...
	try {
		...
		socket.onmessage =function got_packet(msg) {
			...
			if (message.currentArtist){
				artist_name.textContent = message.currentArtist.name;
				byline.textContent = message.currentArtist.byline;
				description.textContent = message.currentArtist.description;
			}
